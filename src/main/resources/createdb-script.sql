...
(
    ...
    CONSTRAINT FK_journal_cat FOREIGN KEY (category_id) REFERENCES category (id),
...
(
    ...
    user_id BIGINT(20) NOT NULL,
    category_id BIGINT(20) NOT NULL,
    CONSTRAINT FK_sub_cat FOREIGN KEY (category_id) REFERENCES category (id)
);
...
(
    ...
    CONSTRAINT FK_update_journal FOREIGN KEY (journal_id) REFERENCES journal (id)
);